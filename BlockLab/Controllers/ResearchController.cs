...
public class ResearchController : Controller
{
    ...
    public async Task<IActionResult> Index(string? name, int? typeId, bool? isNormal, int? objId, ResearchSortState order = ResearchSortState.NameAsc, int page = 1, int pageSize = 10)
    {
